...
//     getOrdersLog() {
//         return this.orders.map(order => `email: ${order.email} dish: ${order.dish}`)
//             .join(" - ");
//     },
//     getEmails() {
...
// ========== ЗАВДАННЯ   5   ЗАДАЧА: ЛАНЦЮЖОК ПРОТОТИПІВ  =======
...
// }
// ========== ЗАВДАННЯ   8  Class ДЕСТРУКТУРИЗАЦІЯ =======
...
// ========== ЗАВДАННЯ   11  ЗАДАЧА: КОНСТРУКТОР РЯДКІВ=======
...
// ========== ЗАВДАННЯ   12  ЗАДАЧА: Інкапсуляція =======
...
// ========== ЗАВДАННЯ   14  ЗАДАЧА: КОНСТРУКТОР РЯДКІВ  =======
...
// ========== ЗАВДАННЯ   15  ЗАДАЧА: Гетери та сетери  =======
...
// ========== ЗАВДАННЯ   17  ЗАДАЧА: static method =======
...
// ========== ЗАВДАННЯ   19  ЗАДАЧА: super(аргументи) - це псевдонім конструктора батьківського класу. =======
//
...
// ========== ЗАВДАННЯ   20  ЗАДАЧА: В дочірньому класі можна оголошувати методи, які будуть доступні тільки його екземплярам. =======
